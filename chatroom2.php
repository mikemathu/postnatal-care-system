...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <h3 style = "margin-left: 40%; margin-top:-40px;  padding-bottom: 20px;" >PATIENT DASHBOARD</h3>
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 30vh">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="admin-panel.php" role="tab" aria-controls="home">Dashboard</a>
...
<div class="panel panel-default" style="height:50px; margin-top:-40px;">
				<span style="font-size:18px; margin-left:10px; position:relative; top:13px; ">Chat Room:<strong> <?php //echo $chat_name; ?></strong></span>
...
<div>
				<div class="panel panel-default" style="height: 360px; overflow:auto; border: outset; border-bottom: none; border-right: none; " >
              ...
              $query = "select * from `chatroommsg_tbl` left join `patient_tbl` on patient_tbl.pid=chatroommsg_tbl.userid where chatroomid='$chatroomid'";
      ...
      $conn=mysqli_connect("localhost","root","","pmsdb");
		$query=mysqli_query($conn,"select * from `patient_tbl` where fname='$username'");
    ...
    $query="insert into chatroomMsg_tbl(userid, chatroomid, message) values ('$userid','$chatroomid','$msg')";
