...
.panel_right {
  ...
  <div class='loader-section section-left panel_left'></div>
  <div  class='loader-section section-right panel_right'></div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"> </script>
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp POSTNATAL CARE</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item" style="margin-right: 40px;">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>LOGIN</h6></a>
          </li>
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">        
         ...
         <div class="col-md-5" style="padding-left: 180px; "></div>

         <div class="col-md-4" style="margin-top: 5%;right: 10%">
