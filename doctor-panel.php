  ...
  if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
    $check_query = mysqli_query($con,"select apptime from appointment_tbl where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
      ...
      if(mysqli_num_rows($check_query)==0){
        ...
        if($query)
        {
          echo "<script>alert('Your visit is successful');</script>";
...
if(isset($_GET['cancel']))
  ...
  {
    $query=mysqli_query($con,"update prescription_tbl set status='1' where ID = '".$_GET['ID']."'");
    if($query)
    {
      echo "<script>alert('Your confirmation is successfully');</script>";
    }
  }
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-book" id="list-book-list" role="tab" data-toggle="list" aria-controls="home">Add Next Visit</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Upcoming Visits</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home">Visits' History</a>
              ...
              <div class="row">
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                     ...
                     <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Add Next Visit</h4>
                      <script>
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-book" onclick="clickDiv('#list-book-list')">
                          Add Next Visit
                        </a>
                      </p>
                    </div>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    ...
                    <div class="panel-body">
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;"> View Upcoming Visits</h4>
                      <script>
                        function clickDiv(id) {
                          document.querySelector(id).click();
                        }
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Immunizations</h4>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                     ...
                     <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-inbox" onclick="clickDiv('#list-inbox-list')">
                          View Inbox
                        </a>
                      </p>
                    </div>
  ...
  <?php 
    ...
    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
    {
     ...
     <td>
        ...
        <button class="btn btn-success">Immunization</button></a>
        <?php } else {
            ...
            <div class="card-body">
              ...
              document.getElementById('patient_fname').onchange = function updateFees(e) {
                ...
                document.getElementById('patient_lname').value = selection;
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Add Visit" class="btn btn-primary" id="inputbtn" style="color: #fff; background-color: #28a745; border-color: #28a745;">
                  </div>
...
<button style="color: #fff; background-color: #28a745; border-color: #28a745;" id="btn2" class="btn btn-primary">Sort By Visiting Date</button>
<br><br>
...
<!-- <th scope="col">Patient ID</th> -->
                    ...
                    <!-- <th scope="col">Immunization Done?</th> -->
                    <th scope="col">Immunization Done</th>
...
<td>
        ...
        { ?>
          ...
          <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&confirm=update" 
              onClick="return confirm('Are you sure you want to confirm this visit  ?')"
              title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-primary">Confirm</button></a>
          <?php } else {

                echo "Immunization Done";
                } ?>
