...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 30vh;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active"  href="admin-panel.php" aria-controls="home">Dashboard</a>
      <a class="list-group-item list-group-item-action "  href="messages.php" aria-controls="home">Messages</a>
...
if(isset($_POST["send"])){
    ...
    $sql = "INSERT into messageInbox_tbl  (sender, receiver, msg) VALUES ('$username', '$docname', '$msgBody')";
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <button style="color: #fff; background-color: #28a745; border-color: #28a745; margin: 1px 0px;" type="submit" name="send" class="btn btn-info btn-lg">Send Message</button>
                    </div>
                </div>
            </form>
            </div>
