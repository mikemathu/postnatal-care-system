...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   ...
   <h3 style = "margin-left: 40%;  padding-bottom: 20px; margin-top:-40px;" >DOCTOR DASHBOARD</h3>
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif; margin-top:-30px
;"> Welcome &nbsp<?php echo $_SESSION['dname'] ?> 
   </h3>
    <div class="row" style="margin-top:-30px;">
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" style="margin-top:20vh;" href="doctor-panel.php" >Back to Dashboard</a>
...
$query = "select * from patient_tbl  where pid='$id'";
$result = mysqli_query($con,$query);
if(!$result){
...
if(isset($_POST["send"])){
    ...
    $sender = $_SESSION['dname'];
    $conn=mysqli_connect("localhost","root","","pmsdb");
    $sql = "INSERT into messageInbox_tbl  (sender, receiver, msg) VALUES ('$sender', '$fname', '$msgBody')";
            ...
            <div class="col-md-8 col-md-offset-2" >
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <button type="submit" name="send" class="btn btn-info btn-lg" style="color: #fff;background-color:#28a745; border-color: #28a745;">Send</button>
                    </div>
                </div>
            </form>
            </div>
